...
public class ScreenshotManager {
    ...
    private final IScreenshotCallBack callBack;
    private final boolean addWatermark;//是否添加水印
    private final boolean addImgWatermark;//是否添加图片水印
    private final int watermarkPosition;//添加水印位置
    private final int paddingTop;
    private final int paddingBottom;
    private final int paddingLeft;
    private final int paddingRight;
    private final String watermarkText;//水印文字
    private final int watermarkTextColor;
    private final int watermarkTextSize;
    ...
    public static Bitmap capture(Activity activity) {
        ...
        Bitmap newBitmap = Bitmap.createBitmap(view.getDrawingCache(), 0, 0, width, height);
        // 销毁缓存信息
