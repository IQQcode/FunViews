package top.iqqcode.module.animations.rain.baserain;
...
import top.iqqcode.lib.common.util.AnimationHelper;
...
public abstract class FallingView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        LayoutParams adViewLayout = new LayoutParams(
                ...
                ViewGroup.LayoutParams.WRAP_CONTENT);
        binding.buoyView.setPadding(UtilHelper.INSTANCE.getDimens(context, top.iqqcode.module.core.R.dimen.tbds10),
                UtilHelper.INSTANCE.getDimens(context, top.iqqcode.module.core.R.dimen.tbds5),
